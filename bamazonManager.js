 ...
 * bamazonManager.js
 * 
 * Manager mode access of bamazon
 * 
 ...
 * @description: Displays all the products in the bamazon database
 * @param:{none}
 */
 ...
 * @description: Displays the low inventory products in the bamazon database
 * @param:{none}
 */
function display_low_inventory(){
 ...
 * @description: Adds inventory for an existing product in the bamazon database
 * @param:{none}
 */
function add_inventory(){
	console.log("\n" 
...
/**
 * @function: add_new_produxt
 * @description: Adds a new product to the bamazon database
 * @param:{none}
 */
 ...
 * @description Function that handles manager input
 * @param {Object} manager_response 
 */
 ...
 * @description Function that displays the manager menu options
 * @param {} None
 */
function manager_display_menu(){
 ...
 * Prefetches some info from the products table in bamazon, then displays the manager menu.
 * @param {} None
 */
function manager_main(){
	 ...
	 * Once connected, 
	 *  - get the names and IDs of all the products and store them in an array 
	 *  - get the names and IDs of all the departments and store them in an array
